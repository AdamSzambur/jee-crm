        ...
        <form style="text-align: left">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                            <select class="custom-select" aria-label="Imie i nazwisko pracownika">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="Koszt roboczogodziny" value="${order.costOfmanHour}">

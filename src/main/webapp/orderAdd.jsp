...
<main role="main" class="flex-shrink-0">
    <div class="container">
        ...
        <p>
        <form style="text-align: left" method="post" action="${pageContext.request.contextPath}/order/orderAdd">
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    <button type="submit" class="btn btn-primary" name="action" value="create">Dodaj nowe zlecenie</button>
                </div>
            </div>
        </form>
        </div>

            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item <c:if test="${empty cat}">active</c:if>">
                    <a class="nav-link" href="${pageContext.request.contextPath}"><i class="fas fa-home"></i> Strona
                        główna<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink1">
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/customer/customerList">Lista
                            klientów</a>
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/customer/customerAdd">Dodaj
                            klienta</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/vehicle/vehicleList">Lista
                            pojazdów</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink3">
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/order/orderList">Lista
                            zleceń</a>
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/order/orderAdd">Dodaj
                            zlecenie</a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink4">
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/employee/employeeList">Lista
                            pracowników</a>
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/employee/employeeAdd">Dodaj
                            pracownika</a>
